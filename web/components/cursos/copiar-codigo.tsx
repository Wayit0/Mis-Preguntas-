...
/**
 * Muestra el link de inscripción del curso con un botón para copiarlo (mismo
 * patrón que `components/colegio/copiar-codigo.tsx`). El link ya incluye el
 * código: compartirlo equivale a permitir que un alumno se inscriba.
 */
